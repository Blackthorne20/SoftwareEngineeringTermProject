...
public class BackgroundGetCourses extends AsyncTask<String,Void,String> {

    Context context;
    AlertDialog alertDialog;
    BackgroundGetCourses(Context ctx){
        context = ctx;
    }
    @Override
    protected String doInBackground(String... params) { //changed void to params
        ...
        String user_register_url = "http://159.65.46.34/getCourses.php";
        try {
