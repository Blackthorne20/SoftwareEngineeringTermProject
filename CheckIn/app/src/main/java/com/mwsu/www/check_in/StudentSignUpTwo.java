...
public class StudentSignUpTwo extends AppCompatActivity {
    ...
    public void onRegister(View view){
        ...
        if(emailNotTaken && EmptyFields && lengthIsgood) {
            String result = "empty";
    ...
    private boolean lengthIsGood(StringBuilder errorMessage){
        ...
        String strMnum = etMnumber.getText().toString();
        ...
        if(strMnum.length() > maxMnum){
            errorMessage.append("\u2022 Mnumber must be less than 40 characters \n\n");
            return false;
        }
