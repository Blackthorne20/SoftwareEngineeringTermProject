...
public class BackgroundRegisterStudent extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    BackgroundRegisterStudent(Context ctx){
        context = ctx;
    }
    @Override
    protected String doInBackground(String... params) { //changed void to params
        ...
        String register_url_stu = "http://159.65.46.34/RegisterStudent.php";
        try {
            ...
            URL url = new URL(register_url_stu);
